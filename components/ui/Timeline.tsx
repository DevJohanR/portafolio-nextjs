      ...
      <div className="mb-6">
        ...
        <div className="max-w-screen-lg mx-auto p-4 text-center">
          <div className="text-white mt-4 text-lg md:text-xl dark:text-gray-300 space-y-4 leading-relaxed">
            <p>Actualmente trabajo como Desarrollador full stack en la empresa Activos Digitales SAS, donde aplico mis habilidades en Node.js, MongoDB, SQL, Next.js, React.js, React Native y PHP/Laravel.</p>
