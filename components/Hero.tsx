        ...
        <div className="flex justify-center relative my-20 z-10">
          <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center text-center">
            ...
            <p className="text-white mt-4">
              +2 años de experiencia. <span className="text-yellow-500 font-bold">Tecnologo en Desarrollo de Software egresado del SENA </span> de Cucuta, Colombia. Especializado en el desarrollo full stack con React, Next, Node y bases de datos.
            </p>
            <div className="mt-4">
              <a href="#about">
